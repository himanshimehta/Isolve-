   ...
   <body id="page-top" data-gr-c-s-loaded="true" class="">
      ...
      <section id="start">
         <div class="container">
            ...
            <form action="http://127.0.0.1:5000/sipred" method="post" id="unique">
            <div class="row">
               <div class="col-lg-12">
              ...
              <div class="row">
               <div class="col-lg-8 mx-auto text-center">
                  <p class="large">The answer for the question is ${siunknown}  ${sianswer}.</p>
               </div>
              </div>
              <br><br>
              <div class="replace">
...
def oppredsuccess(name):
   ...
   return op_page.substitute(op=operator, ans=answer)
...
def sipredsuccess(name):
   ...
   return si_page.substitute(siunknown=var, sianswer=new_value)
